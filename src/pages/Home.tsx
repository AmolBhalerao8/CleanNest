    ...
    <div className="min-h-screen">
      ...
      <section className="relative py-20 lg:py-32 gradient-hero overflow-hidden">
        <div className="absolute inset-0 opacity-20">
          <img 
            src={heroProperty} 
            alt="Beautiful, well-maintained property showcasing CleanNest's professional cleaning services" 
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {valueProps.map((prop, index) => {
              ...
              const imageAlts = [
                ...
                "Well-maintained common area managed through CleanNest's dashboard system",
